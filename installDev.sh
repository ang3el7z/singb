...
wget -O /root/luci-app-singb.ipk https://github.com/Vancltkin/singb/releases/download/v0.1.4c/luci-app-singb.ipk && chmod 0755 /root/luci-app-singb.ipk && opkg update && opkg install /root/luci-app-singb.ipk && /etc/init.d/uhttpd restart
